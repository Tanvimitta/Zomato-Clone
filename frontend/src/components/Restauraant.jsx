...
function Restaurant() {
  ...
  let getRestaurantDetails = async () => {
    ...
    let url = "http://localhost:3040/api/get-single-restaurant-list/" + id;
  ...
  let getMenuItemList = async () => {
    if (localStorage.key(2) == undefined) {
      alert("please login")
    } else {
  ...
  let getPaymentView = async () => {
    ...
    let options = {
      ...
      "image": "https://i.pinimg.com/originals/1a/17/ed/1a17ed134ffeb3461f5d0f3ca0ee227d.png",
      ...
      "handler": async function (response) {
        ...
        const url = 'http://localhost:3040/api/verify-payment'
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                <i>Your payment for this order is <b>{totalPrice} /- </b></i>
              </div>
              ...
              <div className="col-12">
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <a
                    ...
                    data-bs-toggle ={localStorage.key(2) == undefined ? "" :"modal"}  role="button"
                    href={localStorage.key(2) == undefined ? "" :"#exampleModalToggle"}  
